...
--
-- Host: 127.0.0.1
-- Tempo de geração: 09-Nov-2023 às 18:55
...
--
-- Extraindo dados da tabela `alunos1`
--

INSERT INTO `alunos1` (`matricula`, `nome`) VALUES
(1, 'Maria Souza'),
(2, 'João Paulo'),
(3, 'Carlos Albertoi'),
(4, 'Mariana Esteves'),
...
--
-- Estrutura da tabela `alunos_disciplinas1`
--

CREATE TABLE `alunos_disciplinas1` (
  `id` int(11) NOT NULL,
  `matr_aluno` int(11) DEFAULT NULL,
  `cod_disciplina` int(11) DEFAULT NULL,
  `n1` double DEFAULT NULL,
...
--
-- Extraindo dados da tabela `alunos_disciplinas1`
--

INSERT INTO `alunos_disciplinas1` (`id`, `matr_aluno`, `cod_disciplina`, `n1`, `n2`, `n3`, `n4`) VALUES
(1, 1, 1, 10, 8, 7, 9.5),
(4, 3, 2, 6, 5, 7, 4),
(5, 1, 2, 8, 7.5, 6, 7),
(6, 1, 3, 7, 6, 6.5, 7),
...
--
-- Estrutura stand-in para vista `vw_alunos1`
-- (Veja abaixo para a view atual)
--
CREATE TABLE `vw_alunos1` (
`matricula` int(11)
,`aluno` varchar(60)
,`disciplinas` int(11)
);
...
--
-- Estrutura stand-in para vista `vw_boletins`
-- (Veja abaixo para a view atual)
--
...
--
-- Estrutura stand-in para vista `vw_boletins1`
-- (Veja abaixo para a view atual)
--
CREATE TABLE `vw_boletins1` (
`id` int(11)
,`matricula` int(11)
,`aluno` varchar(60)
,`codigo` int(11)
...
--
-- Estrutura para vista `vw_alunos1`
--
DROP TABLE IF EXISTS `vw_alunos1`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_alunos1`  AS SELECT `alunos1`.`matricula` AS `matricula`, `alunos1`.`nome` AS `aluno`, `cont_disciplinas`(`alunos1`.`matricula`) AS `disciplinas`, `cont_situacao_aluno`(`alunos1`.`matricula`,'Aprovado') AS `aprovacoes`, `cont_situacao_aluno`(`alunos1`.`matricula`,'Reprovado') AS `reprovacoes`, `cont_situacao_aluno`(`alunos1`.`matricula`,'Recuperação') AS `recuperacoes` FROM `alunos1` ;

-- --------------------------------------------------------
--
-- Estrutura para vista `vw_boletins`
--
...
-- --------------------------------------------------------
--
-- Estrutura para vista `vw_boletins1`
--
DROP TABLE IF EXISTS `vw_boletins1`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_boletins1`  AS SELECT `alunos_disciplinas1`.`id` AS `id`, `alunos_disciplinas1`.`matr_aluno` AS `matricula`, `alunos1`.`nome` AS `aluno`, `alunos_disciplinas1`.`cod_disciplina` AS `codigo`, `disciplinas`.`nome` AS `disciplina`, `alunos_disciplinas1`.`n1` AS `nota1`, `alunos_disciplinas1`.`n2` AS `nota2`, `alunos_disciplinas1`.`n3` AS `nota3`, `alunos_disciplinas1`.`n4` AS `nota4`, `media`(`alunos_disciplinas1`.`n1`,`alunos_disciplinas1`.`n2`,`alunos_disciplinas1`.`n3`,`alunos_disciplinas1`.`n4`) AS `media`, `situacao`(`alunos_disciplinas1`.`n1`,`alunos_disciplinas1`.`n2`,`alunos_disciplinas1`.`n3`,`alunos_disciplinas1`.`n4`) AS `situacao` FROM ((`alunos_disciplinas1` join `alunos1` on(`alunos_disciplinas1`.`matr_aluno` = `alunos1`.`matricula`)) join `disciplinas` on(`alunos_disciplinas1`.`cod_disciplina` = `disciplinas`.`codigo`)) ;

-- --------------------------------------------------------
--
-- Estrutura para vista `vw_disciplinas`
--
...
--
-- AUTO_INCREMENT de tabela `alunos1`
--
ALTER TABLE `alunos1`
  MODIFY `matricula` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
