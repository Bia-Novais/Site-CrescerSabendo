<?php
    ...
    <html>
        ...
        <body>
            ...
            <!--corpo da página-->
            <a href="boletim2.php"><h2><<<<</h2></a>
            <div class="container" id="inserir_boletim2">
                <form method="POST">
                    ...
                    <div id="div_body">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="nota1" name="nota1" placeholder="Nota 1° Bim"
                            <?php
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="nota2" name="nota2" placeholder="Nota 2° Bim"
                            <?php
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="nota3" name="nota3" placeholder="Nota 3° Bim"
                            <?php
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="nota4" name="nota4" placeholder="Nota 4° Bim"
                            <?php
