...
<nav class="navbar navbar-expand-lg navbar-light bg-body-tertiary">
    <div class="container-fluid">
        <a class="navbar-brand" href="Home.html">
            <img src="imgprof/log.png" alt="Logo" width="98" height="58">
        </a>
        <div class="profile-dropdown ml-auto">
            <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i class="fas fa-user"></i> <?php 
 echo $_SESSION['user_details']['NomeUsuario']; ?>
            </a>
...
<div class="container text-center">
    ...
    <div class="sidebar">
    <a href="aluno.php"><i class="fas fa-home"></i><span class="tooltip">Home</span></a>
<a href="../boletiim/vernotas.php"><i class="fas fa-users"></i><span class="tooltip">Turmas</span></a>
