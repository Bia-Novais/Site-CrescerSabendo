					   ...
					   <div class="table-title">
					     <div class="row">
						     <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
							    <h2 class="ml-lg-2">Cadastro de Turma</h2>
							 </div>
...
<tr>
  ...
  <th><font color ="black">Serie </font> </th>
  ...
  foreach($pro_bd as $pro_mostrar)
    {
      ...
      ?>echo"<tr>"
      <td><?php echo $pro_mostrar[0]; ?></td><?php
      ?>echo"<tr>"
      <td><?php echo $pro_mostrar[1]; ?><button class="btn btn-primary" data-toggle="modal" data-target="#adicionarAlunosModal"<?php echo $turma_id; ?></td>
      <?php 
    }?>
  </table></center>
   ...
   <div class="box-formulario">        
        <div class="formulario">
            ...
            <form name = "turma" method = "POST" action = "">   
                <span>
                    <input name = "Serie" type = "text"class="input-card"  placeholder="Seriee" autocomplete="off" />
      ...
      <div class="box-formulario">        
        ...
        <div class="formulario">
            ...
            <form name = "excl" method = "POST" action = "">   
                <span>
                    <input name = "Id_turma" type = "text"class="input-card"  placeholder="Codigo da turma" autocomplete="off" />
                    <label for="cod"> <i class="icon icon-user-outline"></i> </label>
                </span>
                <div class="box-pulse">
